...
namespace ECafe.Infrastructure.Migrations
{
    ...
    [Migration("20260830124056_AddRefreshTokenSessionId")]
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.Restaurant", b =>
                {
                    ...
                    b.Property<int?>("DefaultWaiterTableLimit")
                        .HasColumnType("integer")
                    ...
                    b.ToTable("restaurants", "core", t =>
                        {
                            t.HasCheckConstraint("ck_restaurants_default_waiter_table_limit_positive", "default_waiter_table_limit IS NULL OR default_waiter_table_limit > 0");
                        });
                });
