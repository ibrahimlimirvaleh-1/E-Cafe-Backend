...
namespace ECafe.Infrastructure.Migrations
{
    ...
    [Migration("20260922113715_AddReservationStatusHistory")]
    partial class AddReservationStatusHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime?>("RestaurantResponseExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("restaurant_response_expires_at");
                    ...
                    b.HasIndex(new[] { "RestaurantResponseExpiresAt" }, "reservations_restaurant_response_expires_at_idx");

                    b.ToTable("reservations", "ops");
                });

            modelBuilder.Entity("ECafe.Domain.Entities.ReservationPaymentInstruction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("reservation_payment_instructions_pkey");

                    b.HasIndex("SentByUserId");

                    b.HasIndex(new[] { "ReservationId", "SentAt" }, "reservation_payment_instructions_reservation_sent_at_idx");

                    b.ToTable("reservation_payment_instructions", "billing");
                });
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.RestaurantWorkingHour", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("restaurant_working_hours_pkey");

                    b.HasIndex(new[] { "RestaurantId", "DayOfWeek" }, "ux_restaurant_working_hours_restaurant_day")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("restaurant_working_hours", "core", t =>
                        {
                            t.HasCheckConstraint("ck_restaurant_working_hours_close_day_offset", "close_day_offset >= 0 AND close_day_offset <= 1");

                            t.HasCheckConstraint("ck_restaurant_working_hours_day_of_week_range", "day_of_week >= 0 AND day_of_week <= 6");

                            t.HasCheckConstraint("ck_restaurant_working_hours_open_closed_not_equal", "is_closed = true OR close_day_offset = 1 OR opens_at <> closes_at");
                        });
                });
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedBy = "",
                            IsDeleted = false,
                            Name = "Restoran cavabı gözlənilir",
                            StatusTypeId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.WorkflowActionRule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 43,
                            ActionCode = "sendPaymentInstruction",
                            EndpointTemplate = "/api/v1/restaurants/{restaurantId}/reservations/{reservationId}/payment-instructions",
                            FlowCode = "reservation",
                            HttpMethod = "POST",
                            IsEnabled = true,
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.ReservationPaymentInstruction", b =>
                {
                    ...
                    b.HasOne("ECafe.Domain.Entities.User", "SentByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.ReservationPaymentProof", b =>
                {
                    b.HasOne("ECafe.Domain.Entities.File", "File")
                        .WithMany("ReservationPaymentProofs")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("ECafe.Domain.Entities.File", b =>
                {
                    ...
                    b.Navigation("ReservationPaymentProofs");
