    ...
    public static class FileTypeSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<FileType>().HasData(
                FileType(FileTypeCode.RestaurantImage, "restaurant_image", true, ".jpg,.jpeg,.png,.webp", "image/jpeg,image/png,image/webp", 10),
                FileType(FileTypeCode.MenuItemImage, "menu_item_image", true, ".jpg,.jpeg,.png,.webp", "image/jpeg,image/png,image/webp", 10),
                FileType(FileTypeCode.UserProfileImage, "user_profile_image", true, ".jpg,.jpeg,.png,.webp", "image/jpeg,image/png,image/webp", 5),
